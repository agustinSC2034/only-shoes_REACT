...
const tarjetaTotalNEW_BALANCE = document.querySelector(".listaCardsNEW_BALANCE")
...
const tarjetaTotalUNDER_ARMOUR = document.querySelector(".listaCardsUNDER_ARMOUR")
